...
Help keep pathways accurate and newcomer-friendly by walking through a guide as if it's your first time. Check that it works, note where you get stuck, flag broken links, and file an issue with what you find.
