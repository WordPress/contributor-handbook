...
If you're a Credits student or contributing from a WordCamp, mention that too. No one expects a formal introduction. People just like to know who's around. And when others introduce themselves, it's nice to reply in thread to welcome them, too.
...
* Include context like links and screenshots in your messages:
  - ❌ help!
  - ✅ Can someone help me with [this guide](https://make.wordpress.org/core/handbook/contribute/)? I'm getting an error on step 1: "fatal: unable to connect to develop.git.wordpress.org" (and then attach a screenshot)
